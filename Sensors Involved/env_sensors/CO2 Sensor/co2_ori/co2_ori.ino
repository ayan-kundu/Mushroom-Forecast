...
void loop() {                                         
  //Serial.println("refresh reading");          //here we go...
  
  if (input_string_complete == true) {                //if a string from the PC has been received in its entirety
    //Serial.println("test reading 1");
    myserial.print(inputstring); //Serial.print(inputstring);                     //send that string to the Atlas Scientific product
